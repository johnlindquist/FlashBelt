...
package org.robotlegs.mvcs
{
	...
	public class Context extends ContextBase implements IContext
	{
		...
		{
			if (_commandMap == null) {
				var commandMapInjector:IInjector = injector.createChild();
				injector.mapValue(IInjector, commandMapInjector, "commandMapInjector");
				_commandMap = new CommandMap(eventDispatcher, commandMapInjector, reflector);
			}
			return _commandMap;
		}
